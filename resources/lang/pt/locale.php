...
return [
  ...
  "Successfully updated user" => "Colaborador usuário com sucesso",
  "Successfully deleted collaborator" => "Colaborador :name deletado com sucesso",
  "Successfully deleted user" => "Usuário :name deletado com sucesso",
  "Successfully activated user" => "Usuário ativado com sucesso",
  "Successfully activated self" => "Você foi ativado com sucesso",
  "Successfully updated me" => "Atualizado com sucesso",
  "Invalid activation code" => "Código de atualização inválido",
  "Successfully updated configuration" => "Configuração atualizada com sucesso",
  "Member" => "Utilizador",
  "Dashboard" => "Painel",
  "Home" => "Home",
