    ...
    <div class="auth-inner py-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <h4 class="card-title mb-1">Mudar senha 🔒</h4>
          <p class="card-text mb-2">É recomendado que a sua senha nova seja diferente da antiga</p>
          ...
          <form class="auth-reset-password-form mt-2" method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group">
              <div class="d-flex justify-content-between">
                <label for="reset-password-new">Senha nova</label>
              </div>
            ...
            <button type="submit" class="btn btn-primary btn-block" tabindex="4">Atualizar senha nova</button>
          </form>
