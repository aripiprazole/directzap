...
(function (window, document, $) {
  ...
  const $body = $('body');
  const $window = $(window);
  const menuWrapper_el = $('div[data-menu="menu-wrapper"]').html();
  const menuWrapperClasses = $('div[data-menu="menu-wrapper"]').attr('class');
  ...
  $.app.menu = {
    ...
    manualScroller: {
      ...
      init: function () {
        const scroll_theme = $('.main-menu').hasClass('menu-dark') ? 'light' : 'dark';
      ...
      update: function () {
        ...
        if ($('.main-menu').data('scroll-to-active') === true) {
          let activeEl, menu, activeElHeight;
    ...
    change: function (compactMenu) {
      const currentBreakpoint = Unison.fetch.now(); // Current Breakpoint
        ...
        $('li.dropdown-submenu').on('mouseenter', function () {
          ...
          if (dd) {
            ...
            if (pageHeight - ddTop - ddHeight - 28 < 1) {
              const maxHeight = pageHeight - ddTop - 170;
              $(this)
                .find('.dropdown-menu')
                .css({
              ...
              const menu_content = new PerfectScrollbar('li.dropdown-submenu.show .dropdown-menu', {
                wheelPropagation: false
              });
            }
    ...
    changeMenu: function (screen) {
      ...
      const menuWrapper = $('div[data-menu="menu-wrapper"]'),
      ...
      function modernMenuExpand() {
        if ($body.data('menu') == 'vertical-menu-modern') {
          ...
          if ($body.hasClass('menu-collapsed')) {
            ...
            const $listItem = $('.main-menu li.menu-collapsed-open'),
        ...
        if ($body.hasClass('menu-collapsed') && $body.data('menu') == 'vertical-menu-modern') {
          setTimeout(function () {
            if ($('.main-menu:hover').length === 0 && $('.navbar-header:hover').length === 0) {
              ...
              if ($body.hasClass('menu-collapsed')) {
                const $listItem = $('.main-menu li.open'),
                  $subList = $listItem.children('ul');
